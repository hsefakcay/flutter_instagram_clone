...
import 'package:instagram_app_clone/data/firebase_service/firestor.dart';
import 'package:instagram_app_clone/data/firebase_service/storage.dart';
    ...
    try {
      if (email.isNotEmpty && password.isNotEmpty && username.isNotEmpty && bio.isNotEmpty) {
        if (password == passwordConfirme) {
          ...
          throw exceptions("password and confirm paswsword should be same");
        }
      } else {
